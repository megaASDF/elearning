...
class _QuizTakingScreenState extends State<QuizTakingScreen> {
  ...
  Future<void> _loadQuiz() async {
    ...
    try {
      ...
      // In production, you'd fetch from question bank
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isAnswered = _selectedAnswers.containsKey(index.toString());
                        ...
                        children: [
                          ...
                          ... List.generate(
                            ...
                            (optionIndex) {
                              ...
                              final isSelected = _selectedAnswers[index.toString()] == optionIndex;
